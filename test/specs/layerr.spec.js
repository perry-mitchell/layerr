    ...
    describe("static", function() {
        describe("fullStack", function() {
            it("returns stacks from all errors", function() {
                ...
                expect(Layerr.fullStack(err3)).to.contain(Layerr.fullStack(err2));
                expect(Layerr.fullStack(err2)).to.contain(Layerr.fullStack(err1));
            });
        });
        ...
        describe("info", function() {
            ...
            it("returns expected properties from Layerr instance", function() {
                const err = new Layerr({ info: { a: true, b: false } }, "Problemo");
            ...
            it("returns merged properties from several instances", function() {
                const err1 = new Layerr({ info: { a: true, b: false } }, "Problemo");
                const err2 = new Layerr({ cause: err1, info: { b: true, c: false } }, "Problemo");
